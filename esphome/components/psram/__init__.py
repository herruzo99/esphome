...
from esphome.components.esp32.const import VARIANT_ESP32S2, VARIANT_ESP32S3, VARIANT_ESP32C6
...
CONFIG_SCHEMA = cv.All(
    ...
    only_on_variant(
        supported=[VARIANT_ESP32, VARIANT_ESP32S3, VARIANT_ESP32S2, VARIANT_ESP32C6],
    ),
)
